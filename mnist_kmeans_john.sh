...
python3 main.py \
    --dataset=mnist --partition_algorithm=ss_tasks \
    ...
    --metatrain_iterations=10000 --meta_batch_size=16 --mt_mode=encenc --mv_mode=gtgt \
    ...
    --test_set=False --train=True --seed_percentage=.25
