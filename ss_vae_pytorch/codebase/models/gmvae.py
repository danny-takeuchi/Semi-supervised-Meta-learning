...
class GMVAE(nn.Module):
    ...
    def negative_elbo_bound(self, x):
        ...
        # compute losses
        kl_log_normal = ut.log_normal(z, mu, var)
        kl_mixture = ut.log_normal_mixture(z, prior[0], prior[1])
        kl = kl_log_normal - kl_mixture
    ...
    def negative_iwae_bound(self, x, iw):
        ...
        kl = ut.log_normal(z, mu_dup, var_dup) - ut.log_normal_mixture(z, prior[0], prior[1])
        rec = -ut.log_bernoulli_with_logits(x_dup, decoder_out)
